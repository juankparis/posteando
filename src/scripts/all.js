...
$(document).on("ready", function inicio () {
	...
	loadCSS('https://fonts.googleapis.com/css?family=Roboto+Slab|Oleo+Script');
	
	var geoposition = require('./lib/geoposition');
	geoposition();

	var peticionsever = require('./lib/peticionsever');
	peticionsever();
